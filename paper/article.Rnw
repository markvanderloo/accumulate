...
certain hot-deck imputation methods \citep{andridge2010review}.  In
...
third example comes from the field of statistical disclosure control
...
publishes an aggregate over larger groups.
