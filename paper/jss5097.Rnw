...
\Keywords{data analysis, estimation, aggregation, \proglang{R}}
...
currently lists 203 \proglang{R} packages that support some form of estimating
...
the form of \proglang{R} package \pkg{accumulate} \citep{loo2022accumulate}.
